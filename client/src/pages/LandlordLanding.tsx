...
export default function LandlordLanding() {
  ...
  const handleContinue = () => {
    // Don't mark onboarding as complete yet - this is just the landing screen
      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-black text-gray-900">
            {language === "it" 
              ? "La tua casa, nelle mani giuste" 
              : "Your home, in the right hands"}
          </h1>
          <p className="text-lg text-gray-600">
            {language === "it"
              ? "Trova l'inquilino perfetto per te"
              : "Find the perfect tenant for you"}
          </p>
        </div>
